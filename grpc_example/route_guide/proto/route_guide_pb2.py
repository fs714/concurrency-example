...
# source: grpc_example/route_guide/proto/route_guide.proto
...
Point = _reflection.GeneratedProtocolMessageType('Point', (_message.Message,), dict(
  DESCRIPTOR = _POINT,
  __module__ = 'grpc_example.route_guide.proto.route_guide_pb2'
